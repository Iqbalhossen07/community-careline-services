...
<header class="flex justify-between items-center p-6 bg-white shadow-md font-body sticky top-0 z-40">
    <div class="flex items-center">
        <h1 class="text-2xl font-bold font-heading text-gray-800 hidden lg:block">Welcome To Community Careline Services
            (Bexley) Ltd
            Admin
            Panel</h1>
    ...
    <div class="relative flex items-center space-x-4">
        ...
        <button id="admin-dropdown-trigger" class="relative group focus:outline-none">
            <img src="uploads/admin_images/<?php echo $admin_photo ?>" alt="Admin Profile"
        ...
        <div id="admin-dropdown-menu"
            class="hidden absolute right-0 top-14 w-56 bg-white rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.12)] border border-gray-100 py-3 animate-fade-in z-50">
            ...
            <a href="my-profile.php"
                class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-sky-50 hover:text-primary-end transition-colors">
            ...
            <a href="logout.php"
                class="flex items-center px-4 py-2 text-sm text-rose-500 hover:bg-rose-50 transition-colors font-bold">
