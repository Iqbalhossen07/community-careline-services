            ...
            <div class="p-8 mb-32 md:mb-0">
                ...
                <div class="bg-white rounded-xl shadow-lg p-8 md:p-10 max-w-7xl mx-auto" data-aos="fade-up">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                        ...
                        <div class="space-y-4">
                            <h3 class="font-body text-xs font-bold text-gray-500 uppercase tracking-widest mb-2">Service
                                Images</h3>

                            <?php if (!empty($images_array)) : ?>
                            <div
                                class="w-full h-64 md:h-80 rounded-xl overflow-hidden shadow-md border border-gray-200 group">
                            ...
                            <div class="grid grid-cols-3 gap-3">
                                ...
                                <div
                                    class="h-24 rounded-lg overflow-hidden shadow-sm border border-gray-200 cursor-pointer opacity-80 hover:opacity-100 transition">
                            ...
                            <?php else : ?>
                            <div
                                class="w-full h-64 bg-gray-100 flex items-center justify-center rounded-xl border-2 border-dashed border-gray-300 font-body">
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="mb-6">
                                <label
                                    class="font-body block text-sm font-bold text-gray-500 mb-1 uppercase tracking-widest">Service
                                    Name</label>
                            ...
                            <div class="mb-8">
                                <label
                                    class="font-body block text-sm font-bold text-gray-500 mb-2 uppercase tracking-widest">Description</label>
                                <div
                                    class="font-body text-gray-700 leading-relaxed prose max-w-none bg-gray-50 p-6 rounded-lg border border-gray-100 overflow-y-auto max-h-[400px]">
                                    <?php echo $desc; ?>
                                </div>
                            </div>
                            ...
                            <div class="mt-auto pt-6 border-t border-gray-200">
                                <a href="edit-service.php?id=<?php echo $service['id']; ?>"
                                    class="font-nav inline-flex items-center px-6 py-3 bg-primary-start text-white rounded-lg shadow hover:bg-primary-end transition font-bold uppercase tracking-wider text-sm w-full md:w-auto justify-center">
