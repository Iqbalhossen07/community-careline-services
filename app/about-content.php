                ...
                <div class="bg-white rounded-xl shadow-lg p-6 md:p-8" data-aos="fade-up">
                    ...
                    <form action="logics.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 gap-8">
                            ...
                            <div>
                                <label for="about_title"
                                    class="font-body block text-sm font-semibold text-gray-700 mb-2">About Title</label>
                                <input type="text" id="about_title" name="title"
                                    ...
                                    placeholder="e.g., Our Identity" required>
                            </div>
                            ...
                            <div class="bg-gray-50 p-6 rounded-lg border border-gray-200">
                                <label class="block text-sm font-semibold text-gray-700 mb-4">About Images
                                    (Multiple)</label>
                                ...
                                <div class="flex flex-col gap-6">
                                    ...
                                    <div class="w-full">
                                        <p class="text-xs text-gray-500 mb-2 uppercase tracking-wide font-bold">Current
                                            Images</p>
                                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                            <?php foreach($current_images as $img): ?>
                                            <div class="relative group h-32 w-full">
                                                <img src="<?php echo $upload_folder . $img; ?>" alt="Current Image"
                                    ...
                                    <div class="w-full">
                                        <label for="file-upload"
                                            class="file-upload-box flex flex-col justify-center items-center h-40 px-6 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer transition-all">
                                            <div class="space-y-2 text-center">
                                                <i class="fa-solid fa-cloud-arrow-up text-3xl text-gray-400"></i>
                                                <div class="text-sm text-gray-600">
                                                    <span
                                                        class="font-medium text-primary-start hover:text-primary-end">Click
                                                        to upload</span>
                                    ...
                                    <div id="new-images-preview" class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-2">
                                    </div>
                        ...
                        <div class="mt-8 text-right">
                            <button type="submit" name="update_about_content"
        ...
        if (files) {
            Array.from(files).forEach(file => {
                ...
                reader.onload = function(e) {
                    ...
                    imgDiv.innerHTML =
                        `<img src="${e.target.result}" class="w-full h-full object-cover rounded-lg shadow-sm border border-green-200">`;
